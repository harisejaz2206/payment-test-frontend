    ...
    <section className="bg-gray-100 py-16">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div key={plan.id} className="p-6 bg-white border rounded-lg shadow-lg text-center">
              <h3 className="text-xl font-semibold mb-4">{plan.name}</h3>
              <p className="text-xl font-bold text-gray-800">${plan.price.toFixed(2)} / month</p>
              ...
              <button className="bg-blue-600 text-white font-semibold py-3 px-6 rounded-full mt-6 hover:bg-blue-700 transition duration-300">
                Select Plan
              </button>
            </div>
          ))}
